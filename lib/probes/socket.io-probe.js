...
SocketioProbe.prototype.attach = function(obj) {
  ...
  var connectCountMetric = metricsManager.findOrCreateMetric('Socket.io', 'Socket count', null, 'avg');
  var totalConnectCountMetric = metricsManager.findOrCreateMetric('Socket.io', 'Total socket count', null, 'inc');
  var sentCountMetric = metricsManager.findOrCreateMetric('Socket.io', 'Messages sent per minute', null, 'sum');
  var receivedCountMetric = metricsManager.findOrCreateMetric('Socket.io', 'Messages received per minute', null, 'sum');
